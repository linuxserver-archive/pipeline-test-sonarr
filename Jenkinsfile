pipeline {
  ...
  environment {
    EXT_RELEASE_TYPE = 'deb_repo'
    EXT_USER = 'none'
    EXT_REPO = 'none'
    BUILD_VERSION_ARG = 'none'
    LS_USER = 'linuxserver'
    LS_REPO = 'pipeline-test-sonarr'
    DOCKERHUB_IMAGE = 'lspipelive/sonarr'
    DEV_DOCKERHUB_IMAGE = 'lspipetest/sonarr'
    ...
    DIST_TAG = 'xenial'
    DIST_PACKAGES = 'none'
    DIST_REPO = 'deb http://apt.sonarr.tv/ master main'
    DIST_REPO_PACKAGES = 'nzbdrone'
  }
  stages {
